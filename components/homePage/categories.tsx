...
// if (!styles) {
//   throw new Error("styles is undefined");
// }
...
// Define categories array with explicit type
...
const ClinicCategories: React.FC<ClinicCategoryProps> = ({title, backgroundColor, textBg, border}) => {
  ...
  return (
    <div className={styles.cliniContainer} style={{backgroundColor: backgroundColor || "#f0f0f0"}}>
      ...
      <div className={styles.gridContainer}>
        {categories.map((category, index) => (
          ...
          style = {{cursor: "pointer", backgroundColor: textBg || "#D9EBFD", border: border || "none"}}
          >
